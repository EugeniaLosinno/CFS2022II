...
function borrarEspecialidad(arr, especialidad) {
    ...
    if (!encontre) {
        throw new Error("La especialidad ".concat(especialidad, " buscada no se encuentra"));
    }
    else {
        console.log("La especialidad ".concat(especialidad, " fue borrada"));
    }
}
...
function modificarMedico(arregloMedicos, posicion, arregloEspecialidades) {
    if (posicion < arregloMedicos.length && posicion > 0) {
        ...
        console.log("El medico fue modificado");
        console.table(arregloMedicos);
    }
    else {
        throw new Error("La posicion se encuentra fuera de rango");
    }
}
