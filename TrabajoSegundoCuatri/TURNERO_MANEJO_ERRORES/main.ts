...
try {
    ...
    borrarEspecialidad(arregloEspecialidades, "clinico");
    console.table(arregloEspecialidades);
}catch(err){
    console.log(err);
...
try {
    console.table(arregloEspecialidades);
    borrarEspecialidad(arregloEspecialidades, "dermatologo");
    console.table(arregloEspecialidades);
}catch(err){
    console.log(err);
    console.log("Ocurrio un error inesperado");
...
try {
    ...
    modificarMedico(arregloMedicos, 9, arregloEspecialidades);
    console.table(arregloMedicos);
}catch(err){
    console.log(err);
    console.log("Ocurrio un error inesperado");
