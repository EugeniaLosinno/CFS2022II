...
//borro una especialidad que no esta
try {
    console.table(arregloEspecialidades);
    (0, helper_1.borrarEspecialidad)(arregloEspecialidades, "clinico");
    console.table(arregloEspecialidades);
}
catch (err) {
    console.log(err);
...
//borro una especialidad que esta
try {
    console.table(arregloEspecialidades);
    (0, helper_1.borrarEspecialidad)(arregloEspecialidades, "dermatologo");
    console.table(arregloEspecialidades);
}
catch (err) {
    console.log(err);
...
//modifico un medico que no esta
try {
    console.table(arregloMedicos);
    (0, helper_1.modificarMedico)(arregloMedicos, 9, arregloEspecialidades);
    console.table(arregloMedicos);
}
catch (err) {
    console.log(err);
